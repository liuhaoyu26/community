...
import com.leaf.community.dao.DiscussPostMapper;
...
class MapperTests {
	...
	public void testSelectUser(){
		...
		user = userMapper.selectByEmail("leaf101@sina.com");
		System.out.println(user);
	}
	...
	public void updateUser() {
		...
		int rows2 = rows = userMapper.updateHeader(150, "http://www.newcoder.com/102.png");
